      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleEmailSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <Link
              href="/api/auth/login"
              className="self-end text-xs text-zinc-500 underline underline-offset-2 hover:text-zinc-900 dark:hover:text-zinc-100"
            >
              Forgot password?
            </Link>
          </div>
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="flex h-10 items-center justify-center gap-2 rounded-lg border border-zinc-200 text-sm font-medium transition-colors hover:bg-zinc-100 dark:border-zinc-800 dark:hover:bg-zinc-900"
          >
